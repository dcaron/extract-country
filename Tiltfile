...
k8s_custom_deploy(
    ...
    apply_cmd="tanzu apps workload apply -f config/workload.yaml --live-update" +
        ...
        " && kubectl get workload extract-country --namespace " + NAMESPACE + " -o yaml",
...
k8s_resource('extract-country', port_forwards=["8080:8080"],
    extra_pod_selectors=[{'serving.knative.dev/service': 'extract-country'}])
